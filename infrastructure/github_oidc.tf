# IAM OIDC Provider for GitHub Actions (allows passwordless login via OpenID Connect)
    ...
    Statement = [
      {
        ...
        Condition = {
          ...
          StringLike = {
            "token.actions.githubusercontent.com:sub" = "repo:PhilippeVienne/NomadRide:*"
          }
        }
      }
    ]
...
# IAM Policy allowing the GitHub Actions role to deploy ECR, S3, and CloudFront
